            ...
            <div class="card-body">
                <form action="<?php echo site_url('barang/save') ?>" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" name="harga_bell" value="<?=$barang->harga_beli;?>" type="text" placeholder="Harga Beli" 
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <?php foreach ($kategori as $kategori): ?>
                            <?php if($barang->kategori_id == $kategori['if']):?>
                    ...
                    <div class="mb-3">
                        ...
                        <?php foreach ($satuan as $satuan): ?>
                            <?php if($barang->satuan_id == $satuan['if']):?>
                    ...
                    <div class="mb-3">
                        ...
                        <?php foreach ($supplier as $supplier): ?>
                            <?php if($barang->supplier_id == $supplier['if']):?>
