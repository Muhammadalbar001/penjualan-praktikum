        ...
        <div class="card mb-4">
            <div class="card-body">
                <form action="<?php echo site_url('barang/save') ?>" method="post">
                    <div class="mb-3">
                        <label for="barkode">Barcode <code>*</code></label>
                        <input class="form-control"  name="barkode" type="text" placeholder="Barcode" 
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="harga_bell">Harga Beli <code>*</code></label>
                        <input class="form-control" name="harga_bell" type="text" placeholder="Harga Beli" 
                    </div>
                    <div class="mb-3">
