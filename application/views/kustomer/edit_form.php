            ...
            <div class="card-body">
                <form action="<?php echo site_url('kustomer/edit') ?>" method="post">
                    <div class="mb-3">
                        ...
                        <input class="form-control" name="nik" value="<?= $kustomer->nik; ?>" type="text"
                            placeholder="Nik">
                    </div>
                    <div class="mb-3">
                        <label>Nama <code>*</code></label>
                        <input class="form-control" name="name" value="<?= $kustomer->name; ?>" type="text"
                            placeholder="Nama">
                    </div>
                    <div class="mb-3">
                        <label>Alamat <code>*</code></label>
                        <input class="form-control" name="alamat" value="<?= $kustomer->alamat; ?>" type="text"
                            placeholder="Alamat">
                    </div>
                    <div class="mb-3">
                        <label>Telp <code>*</code></label>
                        <input class="form-control" name="telp" value="<?= $kustomer->telp; ?>" type="text"
                            placeholder="Telp">
                    </div>
