                ...
                <div class="table-responsive">
                    <table class="table table-striped table-bordered table-hover" width="100%" cellspacing="0">
                        ...
                        echo "<tr>
                                ...
                                <td>
                                <div>
                                    <a href=" . base_url('kustomer/getedit/' . $kustomer->id) . " class='btn btn-sm btn-sm btn-info'><i class='fas fa-edit'></i> Edit </a>
                                    <a href=" . base_url('kustomer/delete/' . $kustomer->id) . " class='btn btn-sm btn-danger'
                                    onclik='return confirm(\"Ingin menghapus data user ini\");'><i class='fas fa-trash'></i> Hapus </a>
                                    </div>
                                </td>
                            </tr>";
                                $no++;
